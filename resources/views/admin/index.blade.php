			...
			<div class="page-main">
					...
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="index.html">
								<img src="../assets/images/brand/logo.png" class="header-brand-img" alt="Lmslist logo">
							</a>
							...
							<div class="d-flex order-lg-2 mr-auto">
								...
								<div class="dropdown d-none d-md-flex country-selector">
									<a href="#" class="d-flex nav-link leading-none" data-toggle="dropdown">
										<img src="../assets/images/flags/us_flag.jpg" alt="img" class="avatar avatar-xs ml-1 align-self-center">
										<div>
								...
								<div class="dropdown d-none d-md-flex">
									...
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
										<a href="#" class="dropdown-item d-flex pb-3">
											<img src="../assets/images/users/male/41.jpg" alt="avatar-img" class="avatar brround ml-3 align-self-center">
											<div>
										...
										<a href="#" class="dropdown-item d-flex pb-3">
											<img src="../assets/images/users/female/1.jpg" alt="avatar-img" class="avatar brround ml-3 align-self-center">
											<div>
										...
										<a href="#" class="dropdown-item d-flex pb-3">
											<img src="../assets/images/users/male/18.jpg" alt="avatar-img" class="avatar brround ml-3 align-self-center">
											<div>
										...
										<a href="#" class="dropdown-item d-flex pb-3">
											<img src="../assets/images/users/female/18.jpg" alt="avatar-img" class="avatar brround ml-3 align-self-center">
											<div>
				...
				<aside class="app-sidebar doc-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-settings"></i><span class="side-menu__label">أدارة الاصناف </span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li><a class="slide-item" href="{{ route('addCatgory')}}">أضافة صنف</a></li>
								<li><a class="slide-item" href="{{ route('listallcatgory') }}"> كل الاصناف</a></li>
